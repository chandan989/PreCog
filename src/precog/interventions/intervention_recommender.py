...
class InterventionRecommender:
    ...
    def _get_issue_type_from_alert(self, alert: Any) -> Optional[str]:
        ...
        if isinstance(alert, FrictionRisk):
            if alert.risk_score > 0.7: # High friction risk could indicate social tension
    ...
    def _get_context_from_alert(self, alert: Any) -> Dict[str, str]:
        ...
        if hasattr(alert, 'location') and alert.location: context['location'] = alert.location
    ...
    def recommend_interventions(
        ...
        def sort_key(alert):
            if isinstance(alert, MisinformationAlert):
                ...
                base_priority = 1
                return (base_priority, -alert.risk_score) 
